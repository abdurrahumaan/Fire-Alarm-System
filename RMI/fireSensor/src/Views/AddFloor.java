...
public class AddFloor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        floor_no.setFont(new java.awt.Font("Calibri", 0, 24)); 
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(floor_no, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            ...
            int x = controllers.insertFloor(new Floor(1, floor_no.getText(), UserController.user_id));
            if (x != 0) {
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(AddFloor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
