                ...
                <div class="card">
                    ...
                    <div class="card-body pt-4">
                        <table class="table table-bordered text-dark">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $sensors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sensorRecord): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($sensorRecord['index']); ?></td>
                                    <td><?php echo e($sensorRecord['floor']); ?></td>
                                    <td><?php echo e($sensorRecord['room']); ?></td>
                                    <td><?php echo e($sensorRecord['sensor']); ?></td>
                                    <td class="text-center">
                                        <svg height="30" width="30">
                                            <circle cx="20" cy="20" r="10" stroke="white" stroke-width="3" fill="<?php echo e($sensorRecord['status']); ?>" />
                                          </svg>
                                    </td>
                                </tr>
...
<?php /**PATH C:\Users\HP\Desktop\Assignment Abdul Malli\Assignment Abdul Malli\Rest API\firealarmsystem\firealarmsystem\resources\views/welcome.blade.php ENDPATH**/ ?>